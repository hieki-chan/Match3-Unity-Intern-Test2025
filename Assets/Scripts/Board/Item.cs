...
public class Item
{
    ...
    public void SetSortingLayerHigher()
    {
        ...
        SpriteRenderer sp = spriteRenderer;
        if (sp)
        {
            sp.sortingOrder = 1;
        }
    ...
    internal void Clear()
    {
        ...
        if (View)
        {
            ...
            GameObject.Destroy(View.gameObject, 2);
            View = null;
        }
    }

    public static bool IsOverlapping(Item item1, Item item2)
    {
        var bounds1 = item1.spriteRenderer.bounds;
        var bounds2 = item2.spriteRenderer.bounds;
